...
public class ReactiveStreamTest {
    ...
    void publish() throws InterruptedException {
        ...
        executor.execute(() -> {
            for (int i = 0; i < 1000; i++) {
                publisher.submit("Dede-" + i);
                System.out.println(Thread.currentThread().getName() + " : Send Dede-" + i);
            }
        });
    ...
    void processor() throws InterruptedException {
        ...
        var subsriber = new PrintSubscriber("A", 1000L);
        processor.subscribe(subsriber);
